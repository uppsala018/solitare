...
export default function TournamentResultsModal({
  open, tournament, myScore, myMoves, leaderboard, currentUserId, onPlayAgain, onClose,
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 pb-3 shrink-0">
              <div>
                ...
                <p className="text-gold font-black text-xl" style={{ fontFamily: "'Fredoka One', cursive" }}>
                  Your Results
                </p>
              </div>
              <button onClick={onClose} className="p-2 rounded-xl opacity-60" style={{ background: 'rgba(255,255,255,0.1)' }}>
            ...
            <div className="px-5 pb-4 shrink-0">
              <div
                ...
                style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(245,200,66,0.25)' }}
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gold font-black text-3xl tabular-nums" style={{ fontFamily: "'Fredoka One', cursive" }}>
            ...
            <div className="flex gap-3 px-5 py-3 shrink-0 safe-bottom" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
              <button
                onClick={onClose}
                className="flex-1 py-3 rounded-2xl border border-white/20 text-white/60 text-sm font-semibold"
              >
                Close
              </button>
              <motion.button
                className="flex-1 py-3 rounded-2xl gradient-gold text-purple-deep font-bold text-sm flex items-center justify-center gap-1.5"
                whileTap={{ scale: 0.96 }}
                onClick={onPlayAgain}
              >
